...
import: "import { DatePickerInput } from '@asuikit/dates';"
source: 'asuikit-dates/src/components/DatePickerInput/DatePickerInput.tsx'
docs: 'dates/DatePickerInput.mdx'
styles: ['DatePickerInput']
---

import { DatePickerInputDemos } from '@asuikit/demos';

## DatePicker props

`DatePickerInput` supports all props from [DatePicker](https://srcalienswap.github.io/as-uikit/dates/date-picker/),
