...
import: "import { DateTimePicker } from '@asuikit/dates';"
source: 'asuikit-dates/src/components/DateTimePicker/DateTimePicker.tsx'
docs: 'dates/DateTimePicker.mdx'
styles: ['DateTimePicker']
---

import { DateTimePickerDemos } from '@asuikit/demos';

## DatePicker props

`DateTimePicker` supports all props from [DatePicker](https://srcalienswap.github.io/as-uikit/dates/date-picker/),
