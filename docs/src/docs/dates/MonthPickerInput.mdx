...
import: "import { MonthPickerInput } from '@asuikit/dates';"
source: 'asuikit-dates/src/components/MonthPickerInput/MonthPickerInput.tsx'
docs: 'dates/MonthPickerInput.mdx'
styles: ['MonthPickerInput']
---

import { MonthPickerInputDemos } from '@asuikit/demos';

## MonthPicker props

`MonthPickerInput` supports all props from [MonthPicker](https://srcalienswap.github.io/as-uikit/dates/month-picker/),
