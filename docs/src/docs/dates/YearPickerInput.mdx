...
import: "import { YearPickerInput } from '@asuikit/dates';"
source: 'asuikit-dates/src/components/YearPickerInput/YearPickerInput.tsx'
docs: 'dates/YearPickerInput.mdx'
styles: ['YearPickerInput']
---

import { YearPickerInputDemos } from '@asuikit/demos';

## YearPicker props

`YearPickerInput` supports all props from [YearPicker](https://srcalienswap.github.io/as-uikit/dates/year-picker/),
