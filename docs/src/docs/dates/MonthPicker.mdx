...
props: ['MonthPicker']
import: "import { MonthPicker } from '@asuikit/dates';"
source: 'asuikit-dates/src/components/MonthPicker/MonthPicker.tsx'
docs: 'dates/MonthPicker.mdx'
styles: ['MonthPicker']
---

import { MonthPickerDemos } from '@asuikit/demos';
...
Usually it is better to specify `@asuikit/dates` package locale in [DatesProvider](/dates/dates-provider/),
