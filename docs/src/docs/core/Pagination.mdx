...
import: "import { Pagination } from '@asuikit/core';"
source: 'asuikit-core/src/Pagination/Pagination.tsx'
docs: 'core/Pagination.mdx'
styles: ['Pagination']
---

import { PaginationDemos } from '@asuikit/demos';
...
If you need more flexibility @asuikit/hooks exports [use-pagination](/hooks/use-pagination/) hook,
