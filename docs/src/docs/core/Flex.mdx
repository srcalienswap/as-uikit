...
props: ['Flex']
import: "import { Flex } from '@asuikit/core';"
source: 'asuikit-core/src/Flex/Flex.tsx'
docs: 'core/Flex.mdx'
---

import { __unsafe_do_no_use_FLEX_SYSTEM_PROPS } from '@asuikit/core';
import { FlexDemos } from '@asuikit/demos';
