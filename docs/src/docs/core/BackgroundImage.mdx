...
import: "import { BackgroundImage } from '@asuikit/core';"
source: 'asuikit-core/src/BackgroundImage/BackgroundImage.tsx'
docs: 'core/BackgroundImage.mdx'
---

import { BackgroundImageDemos } from '@asuikit/demos';
...
```tsx
import { BackgroundImage } from '@asuikit/core';
...
function Demo() {
  return (
    <BackgroundImage
      ...
      target="_blank"
      src="https://srcalienswap.github.io/as-uikit/image.png"
    />
  );
}
```
