...
props: ['Notification']
import: "import { Notification } from '@asuikit/core';"
source: 'asuikit-core/src/Notification/Notification.tsx'
docs: 'core/Notification.mdx'
styles: ['Notification']
---

import { NotificationDemos } from '@asuikit/demos';

## Usage

Notification is a base component for notification system.
Build your own or use [@asuikit/notifications](/others/notifications/) package.
