...
import: "import { Input } from '@asuikit/core';"
source: 'asuikit-core/src/Input/Input.tsx'
docs: 'core/Input.mdx'
styles: ['Input', 'Input.Wrapper']
---

import { InputDemos } from '@asuikit/demos';
...
You can add [default props](/theming/default-props/) on [MantineProvider](/theming/asuikit-provider/)
...
on [MantineProvider](/theming/asuikit-provider/) to add styles to all Inputs:
