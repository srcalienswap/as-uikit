...
props: ['Text']
import: "import { Text } from '@asuikit/core';"
source: 'asuikit-core/src/Text/Text.tsx'
docs: 'core/Text.mdx'
---

import { TextDemos } from '@asuikit/demos';
...
function Demo() {
  return (
    <Text component="a" href="https://srcalienswap.github.io/as-uikit/core/">
      Anchor element
    </Text>
  );
}
