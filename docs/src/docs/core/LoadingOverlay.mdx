...
import: "import { LoadingOverlay } from '@asuikit/core';"
source: 'asuikit-core/src/LoadingOverlay/LoadingOverlay.tsx'
docs: 'core/LoadingOverlay.mdx'
---

import { LoadingOverlayDemos } from '@asuikit/demos';
...
```tsx
import { LoadingOverlay } from '@asuikit/core';
