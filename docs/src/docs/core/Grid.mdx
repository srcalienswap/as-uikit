...
props: ['Grid', 'Col']
import: "import { Grid } from '@asuikit/core';"
source: 'asuikit-core/src/Grid/Grid.tsx'
docs: 'core/Grid.mdx'
---

import { GridDemos } from '@asuikit/demos';
...
You can configure breakpoint values with [MantineProvider](/theming/asuikit-provider/).
...
```tsx
import { Grid, Container } from '@asuikit/core';
