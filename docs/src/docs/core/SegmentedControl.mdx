...
import: "import { SegmentedControl } from '@asuikit/core';"
source: 'asuikit-core/src/SegmentedControl/SegmentedControl.tsx'
docs: 'core/SegmentedControl.mdx'
styles: ['SegmentedControl']
---

import { SegmentedControlDemos } from '@asuikit/demos';
