...
import: "import { Tooltip } from '@asuikit/core';"
source: 'asuikit-core/src/Tooltip/Tooltip.tsx'
docs: 'core/Tooltip.mdx'
styles: ['Tooltip']
---

import { TooltipDemos } from '@asuikit/demos';
...
```tsx
import { Tooltip, Badge } from '@asuikit/core';
