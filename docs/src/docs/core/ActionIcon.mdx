...
props: ['ActionIcon']
import: "import { ActionIcon } from '@asuikit/core';"
source: 'asuikit-core/src/ActionIcon/ActionIcon.tsx'
docs: 'core/ActionIcon.mdx'
---

import { ActionIconDemos } from '@asuikit/demos';
...
function Demo() {
  return (
    <ActionIcon component="a" href="https://srcalienswap.github.io/as-uikit/core/">
      Anchor element
    </ActionIcon>
  );
}
