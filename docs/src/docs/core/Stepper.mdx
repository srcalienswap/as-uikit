...
props: ['Stepper', 'Step']
import: "import { Stepper } from '@asuikit/core';"
source: 'asuikit-core/src/Stepper/Stepper.tsx'
docs: 'core/Stepper.mdx'
styles: ['Stepper']
---

import { StepperDemos } from '@asuikit/demos';
...
You can configure breakpoints with [MantineProvider](/theming/asuikit-provider) or use number to set breakpoint:
...
Loader will replace step icon. You can configure default loader in [MantineProvider](/theming/asuikit-provider/).
