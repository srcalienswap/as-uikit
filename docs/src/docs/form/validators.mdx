...
`@asuikit/form` package exports several functions that can be used in [validation rules object](/form/validation/#validation-with-rules-object).
...
```tsx
import { useForm, isNotEmpty } from '@asuikit/form';
...
```tsx
import { useForm, isEmail } from '@asuikit/form';
...
```tsx
import { useForm, matches } from '@asuikit/form';
...
```tsx
import { useForm, isInRange } from '@asuikit/form';
...
```tsx
import { useForm, hasLength } from '@asuikit/form';
...
```tsx
import { useForm, matchesField } from '@asuikit/form';
