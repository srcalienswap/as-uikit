...
Each `@asuikit/` package that exports components, exports props types for these components as well.
...
import type { DatePickerProps } from '@asuikit/dates';
```
...
```tsx
import { createStyles, Selectors } from '@asuikit/core';
...
```tsx
import { MantineTheme, useMantineTheme } from '@asuikit/core';
...
Other types exported from `@asuikit/core` package:
