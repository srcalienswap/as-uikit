...
```tsx
// theme.ts file
import type { MantineThemeOverride } from '@asuikit/core';
...
To add [MantineProvider](/theming/asuikit-provider/) (and other providers) to your Storybook setup create `preview.tsx`
...
import { MantineProvider, ColorSchemeProvider } from '@asuikit/core';
import { theme } from './theme';
