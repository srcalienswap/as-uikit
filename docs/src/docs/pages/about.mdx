...
import { MantineLogoDemos } from '@asuikit/demos';
...
All `@asuikit/*` packages follow [semver](https://semver.org/):
...
You can also install `@asuikit/ds` package and import `MantineLogo` component:

```bash
yarn add @asuikit/ds

npm install @asuikit/ds
```
