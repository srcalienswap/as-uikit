...
import: "import { useLocalStorage } from '@asuikit/hooks';"
docs: 'hooks/use-local-storage.mdx'
source: 'asuikit-hooks/src/use-local-storage/use-local-storage.ts'
---
...
```tsx
import { useLocalStorage } from '@asuikit/hooks';
...
```tsx
import { useLocalStorage } from '@asuikit/hooks';
import { ActionIcon, ColorScheme } from '@asuikit/core';
...
```tsx
import { useSessionStorage } from '@asuikit/hooks';
