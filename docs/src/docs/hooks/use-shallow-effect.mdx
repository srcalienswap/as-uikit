...
import: "import { useShallowEffect } from '@asuikit/hooks';"
docs: 'hooks/use-shallow-effect.mdx'
source: 'asuikit-hooks/src/use-shallow-effect/use-shallow-effect.ts'
---
...
import { useShallowEffect } from '@asuikit/hooks';
