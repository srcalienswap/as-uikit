...
import: "import { useFocusTrap } from '@asuikit/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'asuikit-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@asuikit/demos';
...
```tsx
import { useFocusTrap } from '@asuikit/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@asuikit/hooks';
