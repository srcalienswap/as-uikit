...
import: "import { useQueue } from '@asuikit/hooks';"
docs: 'hooks/use-queue.mdx'
source: 'asuikit-hooks/src/use-queue/use-queue.ts'
---

import { NotificationsDemos } from '@asuikit/demos';

## Usage

use-queue limits the amount of data in current state and places the rest of it in a queue.
For example, in [@asuikit/notifications](/others/notifications/) package amount of
...
```tsx
import { useQueue } from '@asuikit/hooks';
