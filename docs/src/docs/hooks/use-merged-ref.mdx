...
import: "import { useMergedRef } from '@asuikit/hooks';"
docs: 'hooks/use-merged-ref.mdx'
source: 'asuikit-hooks/src/use-merged-ref/use-merged-ref.ts'
---
...
```tsx
import { useRef } from 'react';
import { useClickOutside, mergeRefs } from '@asuikit/hooks';
