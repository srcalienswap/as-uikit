...
[@asuikit/notifications](https://mantine.dev/others/notifications/) package no longer exports
...
Migrate to [@asuikit/tiptap](https://mantine.dev/others/tiptap/) as soon as possible.
...
- `@asuikit/core` package no longer exports `GroupedTransition` component, use multiple [Transition](https://mantine.dev/core/transition/) components instead
...
You can now use [MantineProvider](https://mantine.dev/theming/asuikit-provider/) to add variants to all Mantine components that support [Styles API](https://mantine.dev/styles/styles-api/)
...
- [@asuikit/notifications](https://mantine.dev/others/notifications/) package now exports `notifications` object that includes functions to show, update, hide, clean and clean queue
- [@asuikit/nprogress](https://mantine.dev/others/nprogress/), [@asuikit/modals](https://mantine.dev/others/modals/) and [@asuikit/spotlight](https://mantine.dev/others/spotlight/) packages now exports `nprogress`, `modals` and `spotlight` objects with all package methods
...
- [@asuikit/form](https://mantine.dev/form/validators/) now exports new `matchesField` validator
