...
import: "import { SpotlightProvider } from '@asuikit/spotlight';"
source: 'asuikit-spotlight/src'
docs: 'others/spotlight.mdx'
installation: '@asuikit/spotlight'
license: MIT
styles: ['SpotlightProvider']
---

import { SpotlightDemos } from '@asuikit/demos';
...
Note that if you are using [MantineProvider](/theming/asuikit-provider/), `SpotlightProvider` must be used as its child:
