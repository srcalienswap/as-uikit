...
props: ['Notifications']
source: 'asuikit-notifications/src'
docs: 'others/notifications.mdx'
pageTitle: 'Mantine Notifications'
description: 'Mantine notifications system'
installation: '@asuikit/notifications'
license: MIT
---

import { NotificationDemos, NotificationsDemos } from '@asuikit/demos';
...
inside [MantineProvider](/theming/asuikit-provider/) next to your `App` component:
...
<Demo data={NotificationsDemos.multiNotifications} />