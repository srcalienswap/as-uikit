...
import: "import { ModalsProvider } from '@asuikit/modals';"
source: 'asuikit-modals/src'
docs: 'others/modals.mdx'
installation: '@asuikit/modals'
license: MIT
---

import { ModalsDemos } from '@asuikit/demos';
...
```bash
yarn add @asuikit/modals
```

Install with npm:

```bash
npm install @asuikit/modals
```
...
```tsx
import { ContextModalProps, ModalsProvider } from '@asuikit/modals';
import { Text, Button } from '@asuikit/core';
...
```tsx
import { openContextModal, closeModal } from '@asuikit/modals';
openContextModal({
  modal: 'demonstration',
