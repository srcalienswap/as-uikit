...
import: "import { Carousel } from '@asuikit/carousel';"
source: 'asuikit-carousel/src'
docs: 'others/carousel.mdx'
installation: '@asuikit/carousel'
styles: ['Carousel']
license: MIT
---

import { CarouselDemos } from '@asuikit/demos';
...
```bash
yarn add embla-carousel-react @asuikit/carousel
```

Install with npm:

```bash
npm install embla-carousel-react @asuikit/carousel
```

## Usage

`@asuikit/carousel` package is based on [embla carousel](https://www.embla-carousel.com/),
...
Note that plugins are not installed with `@asuikit/carousel` package and you will need to
...
To solve this issue use `useAnimationOffsetEffect` hook exported from `@asuikit/carousel` package.
