...
import { TextInput, MultiSelect, NumberInput, MantineProvider, Box } from '@asuikit/core';

const code = `
import { TextInput, MultiSelect, NumberInput, MantineProvider } from '@asuikit/core';
