...
import { MantineProvider, Button, Badge, Group, ButtonStylesParams, rem } from '@asuikit/core';

const code = `
import { MantineProvider, Group, Button, Badge, ButtonStylesParams } from '@asuikit/core';
