...
describe('@asuikit/dropzone/Dropzone', () => {
  itSupportsProviderVariant(Dropzone, defaultProps, 'Dropzone');
  itSupportsSystemProps({
    component: Dropzone,
    props: defaultProps,
    displayName: '@asuikit/dropzone/Dropzone',
  });
  ...
  it('displays LoadingOverlay based on loading prop', () => {
    ...
    expect(loading.querySelectorAll('.asuikit-LoadingOverlay-root')).toHaveLength(1);
    expect(notLoading.querySelectorAll('.asuikit-LoadingOverlay-root')).toHaveLength(0);
  });
