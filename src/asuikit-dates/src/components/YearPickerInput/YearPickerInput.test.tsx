...
describe('@asuikit/dates/YearPickerInput', () => {
  itSupportsSystemProps({
    component: YearPickerInput,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'YearPickerInput',
    othersSelector: '.asuikit-YearPickerInput-input',
    displayName: '@asuikit/dates/YearPickerInput',
  });

  itSupportsFocusEvents(YearPickerInput, defaultProps, '.asuikit-YearPickerInput-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-YearPickerInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'asuikit-YearPickerInput-input'
    );

    expect(container.querySelector('table button')).toHaveClass(
      'asuikit-YearPickerInput-pickerControl'
    );
  });
