...
describe('@asuikit/dates/PickerInputBase', () => {
  ...
  it('supports __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-TestStaticSelector-root');
    expect(screen.getByText('test-value')).toHaveClass('asuikit-TestStaticSelector-input');
  });
  ...
  it('changes between Popover and Modal based on dropdownType prop', () => {
    ...
    expect(container.querySelector('.asuikit-Popover-dropdown')).toBeInTheDocument();
    expect(container.querySelector('.asuikit-Modal-content')).not.toBeInTheDocument();
    expect(screen.getByText('test-children')).toBeInTheDocument();

    rerender(<PickerInputBase {...defaultProps} dropdownOpened dropdownType="modal" />);
    expect(container.querySelector('.asuikit-Popover-dropdown')).not.toBeInTheDocument();
    expect(container.querySelector('.asuikit-Modal-content')).toBeInTheDocument();
    expect(screen.getByText('test-children')).toBeInTheDocument();
  });
