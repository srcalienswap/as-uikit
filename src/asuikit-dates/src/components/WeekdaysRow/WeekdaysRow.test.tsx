...
describe('@asuikit/dates/WeekdaysRow', () => {
  ...
  itSupportsSystemProps({
    ...
    displayName: '@asuikit/dates/WeekdaysRow',
  ...
  it('has correct default __staticSelector', () => {
    render(<Wrapper />);
    expect(screen.getByRole('row')).toHaveClass('asuikit-WeekdaysRow-weekdaysRow ');
  });

  it('supports __staticSelector', () => {
    render(<Wrapper __staticSelector="Month" />);
    expect(screen.getByRole('row')).toHaveClass(
      'asuikit-WeekdaysRow-weekdaysRow',
      'asuikit-Month-weekdaysRow '
    );
  });
