...
describe('@asuikit/dates/MonthLevelGroup', () => {
  itSupportsSystemProps({
    component: MonthLevelGroup,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'MonthLevelGroup',
    displayName: '@asuikit/dates/MonthLevelGroup',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-MonthLevelGroup-monthLevelGroup');
    expect(container.querySelector('table button')).toHaveClass('asuikit-MonthLevelGroup-day');
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<MonthLevelGroup {...defaultProps} __staticSelector="Calendar" />);
    expect(container.firstChild).toHaveClass('asuikit-Calendar-monthLevelGroup');
    expect(container.querySelector('table button')).toHaveClass('asuikit-Calendar-day');
  });
