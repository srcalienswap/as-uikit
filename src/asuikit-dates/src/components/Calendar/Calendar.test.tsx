...
describe('@asuikit/dates/Calendar', () => {
  itSupportsSystemProps({
    component: Calendar,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'Calendar',
    displayName: '@asuikit/dates/Calendar',
  });
  ...
  itHandlesControlsKeyboardEvents(Calendar, 'year', '.asuikit-MonthsList-monthsList', {
    ...defaultProps,
    level: 'year',
  });
  itHandlesControlsKeyboardEvents(Calendar, 'decade', '.asuikit-YearsList-yearsList', {
    ...defaultProps,
    level: 'decade',
  });
