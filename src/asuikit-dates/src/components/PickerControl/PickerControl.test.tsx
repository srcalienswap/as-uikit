...
describe('@asuikit/dates/PickerControl', () => {
  itSupportsSystemProps({
    component: PickerControl,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'PickerControl',
    displayName: '@asuikit/dates/PickerControl',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(screen.getByRole('button')).toHaveClass('asuikit-PickerControl-pickerControl');
  });

  it('supports custom __staticSelector', () => {
    render(<PickerControl {...defaultProps} __staticSelector="Calendar" />);
    expect(screen.getByRole('button')).toHaveClass('asuikit-Calendar-pickerControl');
  });
