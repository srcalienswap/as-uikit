...
describe('@asuikit/dates/YearLevelGroup', () => {
  itSupportsSystemProps({
    component: YearLevelGroup,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'YearLevelGroup',
    displayName: '@asuikit/dates/YearLevelGroup',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-YearLevelGroup-yearLevelGroup');
    expect(container.querySelector('table button')).toHaveClass(
      'asuikit-YearLevelGroup-pickerControl'
    );
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<YearLevelGroup {...defaultProps} __staticSelector="Calendar" />);
    expect(container.firstChild).toHaveClass('asuikit-Calendar-yearLevelGroup');
