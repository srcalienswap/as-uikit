...
describe('@asuikit/dates/DateInput', () => {
  ...
  itSupportsSystemProps({
    ...
    displayName: '@asuikit/dates/DateInput',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-DateInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass('asuikit-DateInput-input');

    expect(container.querySelector('table button')).toHaveClass('asuikit-DateInput-day');
  });
