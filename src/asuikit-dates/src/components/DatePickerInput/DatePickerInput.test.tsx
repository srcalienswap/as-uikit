...
describe('@asuikit/dates/DatePickerInput', () => {
  itSupportsSystemProps({
    component: DatePickerInput,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'DatePickerInput',
    othersSelector: '.asuikit-DatePickerInput-input',
    displayName: '@asuikit/dates/DatePickerInput',
  });

  itSupportsFocusEvents(DatePickerInput, defaultProps, '.asuikit-DatePickerInput-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-DatePickerInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'asuikit-DatePickerInput-input'
    );

    expect(container.querySelector('table button')).toHaveClass('asuikit-DatePickerInput-day');
  });
