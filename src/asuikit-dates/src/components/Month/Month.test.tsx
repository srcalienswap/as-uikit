...
describe('@asuikit/core/Month', () => {
  itSupportsSystemProps({
    component: Month,
    props: defaultProps,
    refType: HTMLTableElement,
    providerName: 'Month',
    displayName: '@asuikit/dates/Month',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.querySelector('table')).toHaveClass('asuikit-Month-month');
    expect(container.querySelector('thead tr')).toHaveClass('asuikit-Month-weekdaysRow');
    expect(container.querySelector('tbody tr td button')).toHaveClass('asuikit-Month-day');
  });

  it('supports __staticSelector', () => {
    const { container } = render(<Month {...defaultProps} __staticSelector="Calendar" />);
    expect(container.querySelector('table')).toHaveClass('asuikit-Calendar-month');
    expect(container.querySelector('thead tr')).toHaveClass('asuikit-Calendar-weekdaysRow');
    expect(container.querySelector('tbody tr td button')).toHaveClass('asuikit-Calendar-day');
  });
