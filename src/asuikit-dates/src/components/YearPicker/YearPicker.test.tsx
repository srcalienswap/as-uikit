...
describe('@asuikit/dates/YearPicker', () => {
  itSupportsSystemProps({
    component: YearPicker,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'YearPicker',
    displayName: '@asuikit/dates/YearPicker',
  });
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-YearPicker-calendar');
  });
