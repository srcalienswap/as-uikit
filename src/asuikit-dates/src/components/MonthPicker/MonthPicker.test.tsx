...
describe('@asuikit/dates/MonthPicker', () => {
  itSupportsSystemProps({
    component: MonthPicker,
    props: defaultProps,
    refType: HTMLDivElement,
    providerName: 'MonthPicker',
    displayName: '@asuikit/dates/MonthPicker',
  });
  ...
  itHandlesControlsKeyboardEvents(
    MonthPicker,
    'decade',
    '.asuikit-MonthPicker-monthsList',
    defaultProps
  );
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-MonthPicker-calendar');
  });

  it('supports custom __staticSelector', () => {
    const { container } = render(<MonthPicker {...defaultProps} __staticSelector="Calendar" />);
    expect(container.firstChild).toHaveClass('asuikit-Calendar-calendar');
  });
});
