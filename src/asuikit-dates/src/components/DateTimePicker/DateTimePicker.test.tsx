...
describe('@asuikit/dates/DateTimePicker', () => {
  itSupportsSystemProps({
    component: DateTimePicker,
    props: defaultProps,
    providerName: 'DateTimePicker',
    othersSelector: '.asuikit-DateTimePicker-input',
    displayName: '@asuikit/dates/DateTimePicker',
  });

  itSupportsFocusEvents(DateTimePicker, defaultProps, '.asuikit-DateTimePicker-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-DateTimePicker-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'asuikit-DateTimePicker-input'
    );

    expect(container.querySelector('table button')).toHaveClass('asuikit-DateTimePicker-day');
  });
