...
import { useDisclosure, useUncontrolled, useDidUpdate, useMergedRef } from '@asuikit/hooks';
      ...
      {currentLevel === 'month' && (
        <div className={classes.timeWrapper}>
          <TimeInput
            ...
            size={size}
            data-asuikit-stop-propagation={__stopPropagation || undefined}
          />
...
DateTimePicker.displayName = '@asuikit/dates/DateTimePicker';
