...
describe('@asuikit/dates/MonthPickerInput', () => {
  itSupportsSystemProps({
    component: MonthPickerInput,
    props: defaultProps,
    refType: HTMLButtonElement,
    providerName: 'MonthPickerInput',
    othersSelector: '.asuikit-MonthPickerInput-input',
    displayName: '@asuikit/dates/MonthPickerInput',
  });

  itSupportsFocusEvents(MonthPickerInput, defaultProps, '.asuikit-MonthPickerInput-input');
  ...
  it('has correct default __staticSelector', () => {
    ...
    expect(container.firstChild).toHaveClass('asuikit-MonthPickerInput-root');
    expect(container.querySelector('[data-dates-input]')).toHaveClass(
      'asuikit-MonthPickerInput-input'
    );

    expect(container.querySelector('table button')).toHaveClass(
      'asuikit-MonthPickerInput-pickerControl'
    );
  });
