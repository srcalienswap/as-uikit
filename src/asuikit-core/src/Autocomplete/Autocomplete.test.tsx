...
const queries = {
  getDropdown: (container: HTMLElement) =>
    container.querySelector('.asuikit-Autocomplete-dropdown'),
  getItems: (container: HTMLElement) => container.querySelectorAll('.asuikit-Autocomplete-item'),
};

describe('@asuikit/core/Autocomplete', () => {
  ...
  itSupportsFocusEvents(Autocomplete, defaultProps, '.asuikit-Autocomplete-input');
  itSupportsSystemProps({
    component: Autocomplete,
    props: defaultProps,
    displayName: '@asuikit/core/Autocomplete',
    refType: HTMLInputElement,
    othersSelector: '.asuikit-Autocomplete-input',
