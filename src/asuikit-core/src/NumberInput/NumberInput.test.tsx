...
const getRightSection = (container: HTMLElement) =>
  container.querySelector('.asuikit-NumberInput-rightSection');

const clickIncrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.asuikit-NumberInput-controlUp'));

const clickDecrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.asuikit-NumberInput-controlDown'));
...
describe('@asuikit/core/NumberInput', () => {
  checkAccessibility([
  ...
  itSupportsSystemProps({
    ...
    props: defaultProps,
    displayName: '@asuikit/core/NumberInput',
