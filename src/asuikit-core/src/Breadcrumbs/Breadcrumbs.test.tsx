...
describe('@asuikit/core/Breadcrumbs', () => {
  ...
  it('renders correct amount of children and separators', () => {
    ...
    expect(container.querySelectorAll('.asuikit-Breadcrumbs-breadcrumb')).toHaveLength(3);
    expect(container.querySelectorAll('.asuikit-Breadcrumbs-separator')).toHaveLength(2);
  });
