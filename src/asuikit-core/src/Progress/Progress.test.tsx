...
describe('@asuikit/core/Progress', () => {
  ...
  it('renders given amount of sections', () => {
    ...
    expect(container.querySelectorAll('.asuikit-Progress-bar')).toHaveLength(3);
  });
  ...
  it('supports props on sections', async () => {
    ...
    await userEvent.click(container.querySelectorAll('.asuikit-Progress-bar')[0]);
    expect(spy).toHaveBeenCalledTimes(1);
    await userEvent.click(container.querySelectorAll('.asuikit-Progress-bar')[1]);
    expect(spy).toHaveBeenCalledTimes(1);
  });
});
