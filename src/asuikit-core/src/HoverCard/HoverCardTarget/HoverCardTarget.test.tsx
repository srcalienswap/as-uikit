...
import { itThrowsContextError, patchConsoleError, createContextContainer } from '@asuikit/tests';
...
describe('@asuikit/core/HoverCardTarget', () => {
  ...
  it('has correct displayName', () => {
    expect(HoverCardTarget.displayName).toEqual('@asuikit/core/HoverCardTarget');
  });
});
