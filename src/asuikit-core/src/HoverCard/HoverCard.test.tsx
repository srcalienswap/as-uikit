...
import { itRendersChildren, checkAccessibility } from '@asuikit/tests';
...
describe('@asuikit/core/HoverCard', () => {
  ...
  it('has correct displayName', () => {
    expect(HoverCard.displayName).toEqual('@asuikit/core/HoverCard');
  });
});
