...
import { itRendersChildren, itSupportsRef, itSupportsSystemProps } from '@asuikit/tests';
...
describe('@asuikit/core/Dialog', () => {
  ...
  it('has correct displayName', () => {
    expect(Dialog.displayName).toStrictEqual('@asuikit/core/Dialog');
  });
});
