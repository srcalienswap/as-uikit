...
describe('@asuikit/core/Box/get-color-value', () => {
  it('returns correct color value from theme', () => {
    expect(getColorValue('orange', DEFAULT_THEME)).toBe(DEFAULT_THEME.colors.orange[9]);
  ...
  //   expect(getColorValue('dimmed', DEFAULT_THEME)).toBe(DEFAULT_THEME.colors.gray[9]);
