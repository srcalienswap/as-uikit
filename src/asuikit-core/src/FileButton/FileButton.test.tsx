...
import { checkAccessibility, itSupportsRef } from '@asuikit/tests';
...
describe('@asuikit/core/FileButton', () => {
  ...
  it('has correct displayName', () => {
    expect(FileButton.displayName).toEqual('@asuikit/core/FileButton');
  });
});
