...
describe('@asuikit/core/Chip', () => {
  ...
  it('displays checked icon when input is checked', () => {
    ...
    expect(checked.querySelectorAll('.asuikit-Chip-checkIcon')).toHaveLength(1);
    expect(notChecked.querySelectorAll('.asuikit-Chip-checkIcon')).toHaveLength(0);
  });
