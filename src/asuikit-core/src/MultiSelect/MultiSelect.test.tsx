...
describe('@asuikit/core/MultiSelect', () => {
  ...
  itSupportsSystemProps({
    ...
    props: defaultProps,
    displayName: '@asuikit/core/MultiSelect',
  ...
  it('Has un-filtered list when disableSelectedItemFiltering is enabled', () => {
    ...
    expect(container.querySelectorAll('.asuikit-MultiSelect-item')).toHaveLength(4);
  });
  ...
  it('Has un-filtered list when disableSelectedItemFiltering is disabled', () => {
    ...
    expect(container.querySelectorAll('.asuikit-MultiSelect-item')).toHaveLength(2);
  });
});
