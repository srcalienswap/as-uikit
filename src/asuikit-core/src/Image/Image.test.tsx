...
describe('@asuikit/core/Image', () => {
  ...
  itSupportsSystemProps({
    component: Image,
    props: defaultProps,
    displayName: '@asuikit/core/Image',
  ...
  it('renders placeholder based on withPlaceholder prop', () => {
    ...
    expect(withPlaceholder.querySelectorAll('.asuikit-Image-placeholder')).toHaveLength(1);
    expect(withoutPlaceholder.querySelectorAll('.asuikit-Image-placeholder')).toHaveLength(0);
  });
  ...
  it('renders a placeholder after having src updated to null', () => {
    ...
    expect(container.querySelectorAll('.asuikit-Image-placeholder')).toHaveLength(0);
    rerender(<Image src={null} withPlaceholder />);
    expect(container.querySelectorAll('.asuikit-Image-placeholder')).toHaveLength(1);
  });
