...
describe('@asuikit/core/Select/SelectItems', () => {
  it('renders nothing found message if data array is empty', () => {
    ...
    expect(withData.querySelectorAll('.asuikit-Select-nothingFound')).toHaveLength(0);
    expect(withoutData.querySelector('.asuikit-Select-nothingFound').textContent).toBe(
      'test-nothing'
    );
  });
  ...
  it('has correct displayName', () => {
    expect(SelectItems.displayName).toStrictEqual('@asuikit/core/SelectItems');
  });
});
