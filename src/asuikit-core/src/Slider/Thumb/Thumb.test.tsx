...
import { itSupportsRef, checkAccessibility } from '@asuikit/tests';
...
describe('@asuikit/core/Thumb', () => {
  ...
  it('shows label based on dragging and labelAlwaysOn props', () => {
    ...
    expect(labelAlwaysOn.querySelectorAll('.asuikit-Slider-label')).toHaveLength(1);
    expect(dragging.querySelectorAll('.asuikit-Slider-label')).toHaveLength(1);
    expect(labelOff.querySelectorAll('.asuikit-Slider-label')).toHaveLength(0);
  });

  it('has correct displayName', () => {
    expect(Thumb.displayName).toStrictEqual('@asuikit/core/SliderThumb');
  });
});
