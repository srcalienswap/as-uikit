...
const queries = {
  getLabel: (container: HTMLElement) => container.querySelector('.asuikit-InputWrapper-label'),
  getError: (container: HTMLElement) => container.querySelector('.asuikit-InputWrapper-error'),
  getRequired: (container: HTMLElement) =>
    container.querySelector('.asuikit-InputWrapper-required'),
  getDescription: (container: HTMLElement) =>
    container.querySelector('.asuikit-InputWrapper-description'),
};

describe('@asuikit/core/InputWrapper', () => {
  itRendersChildren(InputWrapper, defaultProps);
  itSupportsSystemProps({
    component: InputWrapper,
    props: defaultProps,
    displayName: '@asuikit/core/InputWrapper',
