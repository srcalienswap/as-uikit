...
describe('@asuikit/styles/create-styles', () => {
  ...
  it('generates name based on name param', () => {
    ...
    expect(screen.getByText('test-element')).toHaveClass('asuikit-NamedComponent-testObject');
  });
  ...
  it('adds correct static selectors for multiple names', () => {
    ...
    expect(screen.getByText('test-element')).toHaveClass('asuikit-NamedComponent-testObject');
    expect(screen.getByText('test-element')).toHaveClass('asuikit-TestName-testObject');
  });
